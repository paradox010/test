...
export default class datafusionApi {
    ...
    static async getTreeData(params={}){
        const result = await sendPost('/supermind/api/dataSource/getSourceList', 'post', false, params);
        if (!result) {
    ...
    static async getTreeNodeDetail(params={}){
        const result = await sendPost('/supermind/api/dataSource/getOne', 'post', false, params);
        result.dataList.map((item, index)=>{
            item.key = item.dataId?item.dataId:'key_'+index;
            item.no = index+1;
        });
        return {dataList:result.dataList,dataCount:result.dataCount};
    };

    static async getDbItemDetail(params={}){
        const result = await sendPost('/supermind/api/dataSource/getOneDetail', 'post', false, params);
    ...
    static async getDbItemEditInfo(params={}){
        const result = await sendPost('/supermind/api/dataSource/getOneInfo', 'post', false, params);
        return result
    };
    ...
    static async handleAddNewTagSave(params={}){
        const result = await sendPost('/supermind/api/dataSource/addOne', 'post', false, params);

        return result
    };
    //数据库添加操作第二步
    static async handleAddNewTagSave2(params={}){
        const result = await sendPost('/supermind/api/task/addOne', 'post', false, params);

        return result
    };
    //数据库添加操作第二步中的样例查看
    static async getOneSamples(params={}){
        const result = await sendPost('/supermind/api/dataSource/getOneSamples', 'post', false, params);
    ...
    static async selectDocByPid(params={}){
    ...
    static async selectConceptById(params={}){
        ...
        const result = await sendPost('/supermind/api/knowledgeGraph/selectConceptById', 'get', false, {id});
        if (type === 'attr') {
    ...
    static async getOneFields(params={}){
        const result = await sendPost('/supermind/api/dataSource/getOneFields', 'post', false, params);
    ...
    static async getTaskList(params={}){
        const result = await sendPost('/supermind/api/task/getTaskList', 'post', false, params);
    ...
    static async deleteOne(params={}){
        const result = await sendPost('/supermind/api/dataSource/deleteOne', 'post', false, params);
    ...
    static async taskDeleteOne(params={}){
        const result = await sendPost('/supermind/api/task/deleteOne', 'post', false, params);
    ...
    static async updateOneInfo(params={}){
        const result = await sendPost('/supermind/api/task/updateOneInfo', 'post', false, params);
    ...
    static async pauseOne(params={}){
        const result = await sendPost('/supermind/api/task/pauseOne', 'post', false, params);
    ...
    static async resumeOne(params={}){
        const result = await sendPost('/supermind/api/task/resumeOne', 'post', false, params);
    ...
    static async updateOne(params={}){
        const result = await sendPost('/supermind/api/dataSource/updateOne', 'post', false, params);
    ...
    static async getPipelineList(params={}){
        const result = await sendPost('/supermind/api/dataSource/getPipelineList', 'post', false, params);
