...
export default class UploadForm extends React.Component{
    ...
    componentWillReceiveProps(nextProps){
        if ('img' in nextProps) {
            ...
            this.setState({imgURL,uploading:!!imgURL,disabled:nextProps.disabled});
        }
    }
        ...
        return (
            <div className="clearfix">
                <Upload
                    ...
                    onRemove={this.state.disabled?null:this.uploadFormHandleRemove}
                    disabled={this.state.disabled}
                >
                    {this.state.uploading?null:this.state.disabled?<div>无图片</div>:uploadButton}
                </Upload>
