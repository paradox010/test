import { Steps, Form, Row, Col, Button, Alert, Modal, Divider, Select, Tag, Tree, message, Icon,TreeSelect } from 'antd';
...
export default class Child04 extends React.Component{
    ...
    componentDidMount(){
        this.props.actions.getDocType({id:"0"});
    }
    onSubmit = () => {
                ...
                if (!err) {
                    if (this.props.dmlAdd.currentStep === 0) {
                        ...
                        this.props.actions.addNewDmlNextStep({step: 2, data: {
                            ...
                            FORM_ITEM_LIST[2][2].options = opts.map(item=>({value:item.id,label:item.description,key:item.id}))
                        }})
                        ...
                        this.props.actions.addNewDmlNextStep({step: 3, data: {
                        	...
                        	jobDescription:"",
                        	jobDataMapInfo:{
                          		modelName: FORM_ITEM_LIST[2][2].options[parseInt(values.modelName)-1].label,
                          		modelId:"",
    ...
    render(){
        const {currentStep, modalVisible, modalData, modalCurrentConent,docTypeList} = this.props.dmlAdd;
        FORM_ITEM_LIST[1][2].treeData = docTypeList;
        return (
            <div>
                <Card
                    title='添加文档库信息'
                                ...
                                >
                                    <div style={{paddingTop: 50}} key={currentStep}>
                                        ...
                                        <FormItemFactory
                                            ...
                                            loadDataAction={this.props.actions.getChildData}
                                        />
