...
export default class Child12 extends React.Component{
    ...
    async componentDidMount(){
        ...
        const rawHtml = result.dataDetail.rawHtml;
        this.setState({
            dataDetail: !!rawHtml?rawHtml:JSON.stringify(result.dataDetail),
            hasRowHtml: !!rawHtml,
    ...
    render(){
        ...
        if(this.state.dataDetail) {
            dataDetail = JSON.parse(this.state.dataDetail);
        }
                    ...
                    <Card
                        ...
                        body={
                            <div style={{
                                ...
                                {
                                    this.state.hasRowHtml?<div dangerouslySetInnerHTML={{__html: this.state.dataDetail}}></div>:this.state.dataDetail
                                }
                            </div>
