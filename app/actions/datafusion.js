...
export const pageChanges=args=>({
    type:'datafusion/saga/PAGE_CHANGE',
    args
})
...
//获取文档类型
export const getDocTypeDb=args=>({
    type:"datafusionChildDbAdd/saga/GET_DOC_TYPE",
    args
})
...
//获取文档类型
export const getDocType=args=>({
    type:"datafusionChildDmlAdd/saga/GET_DOC_TYPE",
    args
})
//异步获取文档子节点
export const getChildData=args=>({
    type:"datafusionChildDmlAdd/saga/GET_DOC_CHILD_TYPE",
    args
})
